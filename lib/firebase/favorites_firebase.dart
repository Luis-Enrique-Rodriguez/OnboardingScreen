...
class FavoritesFirebase{
  ...
  FavoritesFirebase(){
    _favoritesCollection = _firebase.collection('favorites'); //Nombre de la base da datos
  }
  ...
  Future<void> updFavorites(Map<String, dynamic> map, String id) async  {
    return _favoritesCollection!.doc(id).update(map);
  }

  Future<void> delFavorites(String id) async  {
